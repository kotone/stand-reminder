...
### 🎨 六大美学主题与沉浸式引导
应用内置了六种精心设计的艺术风格，每种风格都配有专门定制的 **动态 SVG 引导动画** 和 **主题专属漂浮粒子背景**：
*   **星空冥想**：静谧的夜空、环绕的星体，配合 4 秒吸气、4 秒呼气的禅意呼吸光环，带你瞬间进入冥想放松状态。
*   **赛博霓虹**：充满科技感的霓虹网格与二进制数字流（0/1），配合赛博小人动画，引导你进行背部与肩关节的激活拉伸。
*   **森林朝露**：清爽的森林背景与飘落的绿叶、朝露，引导你站直身体、眺望远方，放松疲惫的双眼。
*   **极夜幻境**：迷幻的深紫极夜光束，辅以 WebGL 粒子旋转。
*   **律动几何**：跟随周期自动触发的 2D 几何粒子扩散波动。
*   **时空漩涡**：极具科幻感的 WebGL2 旋转星云漩涡与漫天繁星。
